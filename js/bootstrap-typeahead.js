...
!function($){
    ...
    var Typeahead = function (element, options) {
        ...
        this.shown = false
        this.objectKey = this.options.objectKey
        this.listen()
    }
    ...
    Typeahead.prototype = {
        ...
        , updater: function (item) {
            ...
            return this.objectKey ? item[this.objectKey] : item
        }
        ...
        , matcher: function(item) {
            ...
            var itemToTestAgainst = this.objectKey ? item[this.objectKey] : item
        ...
        , sorter: function(items) {
            ...
            while (item = items.shift()) {
                //extract item from object if necessary
                itemToTestAgainst = this.objectKey ? item[this.objectKey] : item
        ...
        , highlighter: function (item) {
            var query = this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, '\\$&'),
                //extract item from object if necessary
                ret = this.objectKey ? item[this.objectKey] : item
        ...
        , keyup: function (e) {
            switch(e.keyCode) {
                ...
                default:
                    if (this.sourceUrl) this.populateSource() //calls lookup after request finishes
                    else this.lookup()
            }
